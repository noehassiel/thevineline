            ...
            @foreach ($banners as $banner)
                <div class="banner-wrap" style="position: relative;">
                    ...
                    <div class="banner-img">
                        ...
                        @else
                            <img style="z-index: 1; position: relative;" src="{{ asset('img/banners/' . $banner->image) }}"
                                alt="" class="main-img">
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="cat-item mb-20">
                            ...
                            <div class="content mt-3">
                                ...
                                <a href="{{ route('catalog', $category->slug) }}" class="btn btn-outline-secondary">Comprar
                                    Ahora</a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="banner-main" style="background:#f9f8f5;">
        ...
        @else
            <div class="banner-wrap" style="position: relative;">
                ...
                @else
                    <iframe frameborder="0" height="100%" width="100%"
                        src="https://youtube.com/{{ $banner_promo->video_background }}?autoplay=1&controls=0&showinfo=0&autohide=1"
                        style="z-index: 2; position: absolute;"></iframe>
                @endif
                <div class="container">
                    <div class="row">
                ...
                <div class="banner-img">
                    ...
                    @else
                        <img style="z-index: 1; position: relative;"
                            src="{{ asset('img/banners/' . $banner_promo->image) }}" alt="" class="main-img">
                    @endif
                </div>
            </div>
        @endif
