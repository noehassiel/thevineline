            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="form-check">
                        <input class="form-check-input new-address responsive-one" type="radio" name="addressRadio"
                            id="addressRadio_new" checked="" onchange="newAdress()" checked>
                        <input class="form-check-input new-address responsive-two" type="radio" name="addressRadio"
                            id="addressRadio_new" onchange="newAdress()">
                        <label class="form-check-label" for="addressRadio_new">
                            <span class="responsive-one">Nueva Dirección</span> <span class="responsive-two">Dirección de
                                Envío</span>
                        </label>
                    </div>
                ...
                <div class="card-body card-body-new-add" id="new_address_body">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="street_num" name="street_num"
                                    value="{{ $address->street_num ?? '' }}" required="" />
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-4">
                            <div class="mb-3">
                                <label class="form-label" for="zip">Código Postal <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="postal_code" name="postal_code"
                                    value="{{ $address->postal_code ?? '' }}" required="" autocomplete="off" />
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="city">Ciudad / Municipio <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="zip">Colonia / Fraccionamiento <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label" for="zip">Referencias <span
                                        class="text-danger">*</span></label>
        ...
        <div class="col-md-12">
            @foreach (Auth::user()->addresses->take(3) as $address)
                <div class="card mb-2">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="form-check">
                            <input class="form-check-input option-address" type="radio" name="addressRadio"
                                id="addressRadio_{{ $address->id }}" onchange="newAdress()">
                    ...
                    <div id="addressCard_{{ $address->id }}" class="card-body card-body-old-add" style="display:none;">
                        ...
                        <input type="text" class="form-control" name="street_num"
                            value="{{ $address->street_num ?? '' }}" required="" disabled />
                        <input type="text" class="form-control" name="int_num" value="{{ $address->int_num ?? '' }}"
                            disabled />
                        <input type="text" class="form-control" value="{{ $address->suburb ?? '' }}" required=""
                            disabled />
                        <input type="text" class="form-control" id="postalCode_{{ $address->id }}"
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <label>
                        <input type="checkbox" name="save_address" value="false" id="save-address"> Guardar esta
                        dirección para después</label>
                </div>
                <div class="card-body card-body-new-add" id="new_address_body">
                    <div class="row">
                        <div class="col-12 col-md-7">
                            <div class="mb-3">
                                <label class="form-label" for="last-name">Calle <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="street" name="street"
                                    value="{{ $address->street ?? '' }}" required="" />
                            </div>
                    ...
                    success: function(response) {
                        if (response.length == 0) {
                            ...
                            response.forEach(element => {
                                $('#suburb').append(
                                    `<option value="${element['suburb']}">${element['suburb']}</option>`
                                );
                            });
