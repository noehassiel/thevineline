        ...
        <div class="cart-item-media d-flex mb-3">
            ...
            <div class="flex-grow-1 ms-3 flex-column">
                ...
                @if ($cart_product['item']['has_discount'] == true && $cart_product['item']['discount_end'] > Carbon\Carbon::today())
                    ...
                    <div class="wk-price wk-price-discounted" style="font-size:.7em !important; ">
...
<div class="d-block">
    <a class="btn p-3 d-block btn-primary mb-2" href="{{ route('checkout') }}"><ion-icon
            name="bag-check-outline"></ion-icon> Completar tu compra </a>
    <a class="btn d-block btn-secondary mb-2" href="{{ route('cart') }}"><ion-icon name="bag-outline"></ion-icon> Ver
        tu bolsa</a>
</div>
@guest
    <p class="alert alert-warning" style="display: inline-block;">
        <ion-icon name="alert-circle-outline" class="mr-1"></ion-icon> Estas comprando como <strong>invitado.</strong>
        Compra más rápido creando una cuenta <a href="{{ route('register') }}" class="btn"
            style="color: var(--primary)">Regístrate</a>
    </p>
@endguest
