            ...
            <div class="col-12 col-md-6">
                <div class="d-flex align-items-center justify-content-end">
                    @if ($store_config->phone != null)
                        <a href="" class="contact_action me-3"><ion-icon name="call"></ion-icon>
                            {{ $store_config->phone }}</a>
                    @endif

                    @if ($store_config->contact_email != null)
                        <a href="" class="contact_action me-3"><ion-icon name="mail"></ion-icon>
                            {{ $store_config->contact_email }}</a>
                    @endif
                </div>
            </div>
        </div>
...
<footer class="we-co--footer text-center">
    <div class="container">
        <div class="we-co--reasurrence-links row align-items-center justify-content-between">
            @if (!empty($card_payment))
                <div class="col-6 col-md-3 mt-4">
                    <img src="{{ asset('img/icons/card-info.png') }}"
                        style="height: 33px; margin-bottom: 5px; width: auto !important;">
            ...
            @if (!empty($mercado_payment))
                <div class="col-6 col-md-3 mt-4">
                    <img src="{{ asset('assets/img/brands/mercado-pago.png') }}"
                        style="height: 30px; margin-bottom: 5px; width: auto !important;">
            ...
            @endif
            <div class="col-6 col-md-3 mt-4">
                <img src="{{ asset('img/icons/openpay.jpg') }}"
                    style="height: 33px; margin-bottom: 5px; width: auto !important;">
            </div>
        </div>
